...
def build_delivery_package(
    ...
    try:
        ...
        for asset in assets:
            ...
            # 差异2修复：manifest 补充 type（意图标签）和 qa_score（AI评分总和）
            slot_plan = None
            try:
                from pipeline.models.slot_plan import SlotPlan
                ...
                slot_plan = (
                    ...
                    .filter(
                        ...
                        SlotPlan.slot_index == asset.slot_index,
                    )
                    .first()
                )
            except Exception:
            ...
            manifest_slots.append(
                {
                    ...
                    "type": slot_plan.intent_tag if slot_plan else None,
                    "qa_score": sum(scored) if scored else None,
                    "image_path": dest,
                    "qa_status": "passed",
                }
            )
