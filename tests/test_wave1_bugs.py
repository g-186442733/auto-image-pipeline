...
class TestB3ASINValidation:
    ...
    def test_web_route_validates_asin(self):
        """POST /project/new redirects to unified input form."""
        _make_in_memory_db()
        ...
        # Old route now redirects to /input/new
        resp = client.post(
            "/project/new",
            data={
                "name": "Test",
        ...
        assert resp.status_code == 302, "Legacy route should redirect to /input/new"
